...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104215832717.png)

设置完成之后，点击右方的 `Test`，如果 Git 安装成功且路径正确，就会弹出如下的提示信息，说明我们的配置也就成功了。

![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104220024375.png)‘

## Github 设置

同样的，我们可以发现 `Version Control` 中还有一个 Github 选项卡，这里我们可以使用自己的 Github 账号进行登录，即 `Log In via Github`，然后就可以直接将我们 Github 上的代码拉取下来了。

![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104220328785.png)

登陆成功后，则会出现我们 Github 账号的相关信息，如下图。

![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104220458955.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104221202562.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104221440823.png)

拉取成功后，我们就可以通过 IDEA 打开该项目，依次进入 `File -> Open`，然后找到上一步中克隆下来的代码所在路径，即可打开项目。

![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104221740159.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104222018897.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104222450019.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104223500013.png)

![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104223538034.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104225334377.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104230539689.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104231246644.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104231828830.png)

2.   **工具栏按钮**

同样的，我们也可以通过工具栏中的按钮进行提交，点击该按钮后，出现的界面应该和通过快捷键提交方式的界面一致。

![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104232607426.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104233312367.png)

2.   **工具栏按钮**

通过工具栏按钮，我们同样进行推送工作，点击如下图中的按钮后，出现的界面应该和通过快捷键推送的界面一致。

![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104233520319.png)

3.   **鼠标右键**

通过在项目上点击鼠标右键，然后选择 `Git -> Push`，同样可以进行我们的推送工作。

![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104233747432.png)
...
![](https://cdn.jsdelivr.net/gh/cunyu1943/blog-imgs@main//blog/image-20220104234403920.png)
