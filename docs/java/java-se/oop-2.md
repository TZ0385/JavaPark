...
在上一篇文章 [何为面向对象（上）](https://mp.weixin.qq.com/s?__biz=MzIyNTg2MjkzNw==&mid=2247493594&idx=1&sn=f97c14f70a3d1bc4ae3036eac10a2f47&chksm=e87b93acdf0c1abaeb0358f16feccd59547d6d76bed50dbe4f08221311b41126d6f801517f84&token=121379199&lang=zh_CN#rd) 中，讲到了面向的 3 大特性（**封装、继承、多态**）和面向对象设计的 5 大原则（SRP、OCP、LSP、DIP、ISP）。此外，我们还讲了如何创建一个类，并且在创建类后如何构造一个对象。然后还介绍了类中的属性和方法，并对构造方法和引用也做了简单的讲解。
