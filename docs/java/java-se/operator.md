...
[之前的文章](https://mp.weixin.qq.com/s?__biz=MzIyNTg2MjkzNw==&mid=2247495019&idx=4&sn=a7e98170483b48932ed3bef8af3bc3d8&chksm=e87b991ddf0c100bc827a3c861e78d962ccaaaf1983888a3112894c0c52077b169912d783647#rd) 中介绍了 Java 变量和数据类型，那么如何对他们进行运行算呢？这就要用到运算符的相关知识点了。所谓运算符，就是指 Java 中对变量或者字面量进行操作的符号。下面就来具体看看，常用的操作符。
