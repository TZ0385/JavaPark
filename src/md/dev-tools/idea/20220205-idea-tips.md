...
![](../../../.vuepress/public/img/idea/20220205-idea-tips/paste.png)

同时，在 IDEA 中，默认粘贴时是会对代码自动格式化的。如果我们不想让它自动格式化，那么此时可以利用快捷键 `Ctrl + Alt + Shift + V` 进行粘贴。或者通过右键菜单，选择 `Paste as Plain Text` 进行粘贴；

![](../../../.vuepress/public/img/idea/20220205-idea-tips/paste-as-plain.png)
...
![](../../../.vuepress/public/img/idea/20220205-idea-tips/jump-row.png)
...
![](../../../.vuepress/public/img/idea/20220205-idea-tips/file-list.png)

### 快速打开文件所在文件夹

要打开文件所在文件夹，一般是通过选中文件，然后鼠标右键选中 `Show in Explorer` 即可；

![](../../../.vuepress/public/img/idea/20220205-idea-tips/file-location.png)
...
![](../../../.vuepress/public/img/idea/20220205-idea-tips/search.png)

![](../../../.vuepress/public/img/idea/20220205-idea-tips/replace.png)

### 文件查找

要快速查找文件，可以通过 `Ctrl + Shift+ N` 来进行查找；

![](../../../.vuepress/public/img/idea/20220205-idea-tips/file-search.png)

### 查找菜单或操作

通过 `Ctrl + Shift + A` 快捷键，然后就能通过关键字来查找我们所需要的菜单和操作；

![](../../../.vuepress/public/img/idea/20220205-idea-tips/search-menu.png)

### 万能查找

通过双击两次 `Shift`，来实现万能查找，既可以实现文件查找，也可以实现菜单、操作查找，但是要注意的是它不能进行文件内容查找；

![](../../../.vuepress/public/img/idea/20220205-idea-tips/double-shift.png)
