...
首先，我们创建一个 Maven 项目，如果不太熟悉如何创建，可以参考我之前的一篇教程 -> [使用 IDEA 创建 Maven 项目](https://cunyu1943.github.io/JavaPark/md/java/maven/20220104-maven-project-with-idea)

接着我们分别创建 DAO 层和 Service 层接口，并实现其接口，最后则是在主程序入口中调用，创建后的项目结构如下：

![](../../../.vuepress/public/img/spring/20220202-ioc/ioc-demo.png)
...
![](../../../.vuepress/public/img/spring/20220202-ioc/console-res.png)
