...
IoC --> D[1. 控制反转]
IoC --> E[2. 依赖注入]
E[2. 依赖注入]  --> F[2.1 setter 注入]
E[2. 依赖注入]  ---> B[2.2 构造器注入]
IoC ---> C[3. IoC 在 Spring 中的实现]
```
...
![](https://img-blog.csdnimg.cn/d693214dfcda4e609b031be4389ea208.png)

- **XML 配置方式**

在 `Spring` 配置文件中配置以下属性，然后通过 `id`  获取 `Bean`  的方式获取相关属性。
...
![](https://img-blog.csdnimg.cn/22c5599115d44854860dc4db0f18085a.png)
...
![](https://img-blog.csdnimg.cn/954ed380994e4da38c76f4908f43c7d2.png)
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="book" class="io.github.cunyu1943.domain.Book">
        ...
        <constructor-arg name="name" value="《少年歌行》"></constructor-arg>
        <constructor-arg name="price" value="56.5"></constructor-arg>
    </bean>
</beans>
```
...
![](https://img-blog.csdnimg.cn/54d89439e26646688067bf39c66b330c.png)
...
![](https://img-blog.csdnimg.cn/173e31d0cb8042bab94ae43ffb54a657.png)
...
![](https://img-blog.csdnimg.cn/7c7f81c8a83e47f99c9344a3684a2e86.png)
...
![](https://img-blog.csdnimg.cn/6473c974bf944270b3781f217e2eeb1f.png)
...
![](https://img-blog.csdnimg.cn/6b1723ba1c8d473c830e79bfe69095f4.png)
...
![](https://img-blog.csdnimg.cn/046bec5aedcc4cfe891f2448d765ec32.png)
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="book" class="io.github.cunyu1943.domain.Book">
        ...
        <property name="author">
            <bean id="authorInner" class="io.github.cunyu1943.domain.Author">
                <property name="age" value="45"></property>
                <property name="name" value="都梁"></property>
            </bean>
        </property>
...
![](https://img-blog.csdnimg.cn/68be95cbc4b34a12ba82efc8c6e544ab.png)

但值得注意的是，内部 `Bean` 只能用于给属性赋值，而不能在外部通过 `IoC` 容器获取，因此可以省略 `id` 属性。也就是说，上边的配置也可以配置成以下的方式。
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="book" class="io.github.cunyu1943.domain.Book">
        ...
        <property name="author">
            <bean class="io.github.cunyu1943.domain.Author">
                <property name="age" value="45"></property>
                <property name="name" value="都梁"></property>
            </bean>
        </property>
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="book" class="io.github.cunyu1943.domain.Book">
        ...
        <property name="author.name" value="测试"></property>
        <property name="author.age" value="55"></property>
    </bean>
    <bean id="author1" class="io.github.cunyu1943.domain.Author">
        <property name="age" value="45"></property>
        <property name="name" value="都梁"></property>
    </bean>
...
![](https://img-blog.csdnimg.cn/ad9e214579e2441e930b5a29bf931b91.png)
